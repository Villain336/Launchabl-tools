export const siteConfig = {
  ...
  description:
    "Find licensed lawn care, cleaning, HVAC, junk removal, roadside assistance, towing, plumbing, and more across North Carolina — or run your service business on the Launchabl OS. Agency Launch is $1,200 to get set up; Managed Growth is $497/month.",
  price: "$1,200",
