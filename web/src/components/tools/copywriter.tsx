  ...
  return (
    <div>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          <label className="text-sm font-medium text-slate-700">Product / offer</label>
          <input
            value={product}
      ...
      {variations && (
        <div className="mt-6 space-y-3">
          {variations.map((v, i) => (
            <div key={v} className="flex items-center justify-between gap-3 rounded-lg bg-slate-50 px-4 py-3 text-sm">
              <span>{v}</span>
              <button
                onClick={() => {
