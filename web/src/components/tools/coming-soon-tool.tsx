...
export function ComingSoonTool({
  ...
  return (
    <div className="flex flex-col items-center py-6 text-center">
      ...
      <h3 className="mt-4 text-lg font-semibold text-foreground">This tool is on our public roadmap</h3>
      <p className="mt-2 max-w-md text-sm text-muted-foreground">
        We ship tools in the open — see the <a href="/roadmap" className="text-primary underline">roadmap</a> for
      ...
      {submitted ? (
        ...
        >
          <input
            ...
            className="flex-1 rounded-full border border-border px-4 py-2 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/30"
          />
      ...
      <div className="mt-8 w-full max-w-md rounded-xl bg-muted p-5 text-left">
