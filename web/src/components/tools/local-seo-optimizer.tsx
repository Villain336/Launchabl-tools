  ...
  return (
    <div>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div>
          <label className="text-sm font-medium text-slate-700">City / service area</label>
          <input
            value={city}
      ...
      <div className="mt-8 space-y-6">
        ...
        <div>
          <p className="text-sm font-semibold text-slate-900">Suggested categories</p>
        ...
        <div>
          <p className="text-sm font-semibold text-slate-900">Suggested Q&A starters</p>
        ...
        <div>
          <p className="text-sm font-semibold text-slate-900">Review response templates</p>
          <div className="mt-2 space-y-3">
            <Block
...
function Block({
  ...
  return (
    <div>
      ...
      <div className={`mt-2 flex items-start justify-between gap-3 rounded-lg bg-slate-50 p-4 text-sm text-slate-700 ${mono ? "whitespace-pre-line" : ""}`}>
        <span>{text}</span>
        <button onClick={onCopy} className="flex-shrink-0 text-slate-400 hover:text-indigo-600">
