...
import { useEffect, useMemo, useState, type ComponentType, type PointerEvent, type ReactNode } from "react";
...
function chartIndexFromPointer(event: PointerEvent<HTMLDivElement>, pointCount: number) {
...
export default function InsightCards({
  ...
  return (
    <div className="min-h-[408px] w-full max-w-full">
      {/* pager header */}
      <div className="flex items-center justify-between">
